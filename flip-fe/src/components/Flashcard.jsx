...
export default function Flashcard(){
    ...
    useEffect(() => {
        async function getUrlValue(){
            const url_value = await axios.post("http://18.117.115.172:8081/getCardImage", {
                key:pic_key
            })
    ...
    const fetchCards = async(ilang_value, olang_value) => {
        ...
        const res = await axios.post("http://18.117.115.172:8081/generateflashcards", {
    ...
    const addRating = async (translator_id, curr_rating) => {
        const res = await axios.post("http://18.117.115.172:8081/addrating", {
            id : translator_id,
            rating : curr_rating
        })
